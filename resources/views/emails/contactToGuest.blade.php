...
<body style="box-sizing: border-box; margin: 0; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f4f4f4e4;">
    <div style="display: none; line-height: 0; font-size: 0;">Hey {{ $contact->name }}, thanks for Contact with Salty Waves - your Consultation  is Under Review ✔</div>
          ...
          <tr>
            ...
            <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                    <td width="80%">
                        <h1 class="sm-text-lg all-font-roboto" style="font-weight: 700; line-height: 100%; margin: 0; margin-bottom: 4px; font-size: 24px;">Consultation Request Received!</h1>
                        <p class="sm-text-xs" style="margin: 0; color: #a0aec0; font-size: 14px;">Consultation Email Confirmation</p>
                      </td>
              ...
              <p>
                ...
                Thank you for reaching out to Salty Waves! We've received your consultation request through our contact us form and appreciate your interest in our surf and yoga experiences.
              ...
              <table class="sm-leading-32" style="line-height: 28px; font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  ...
                  <td class="sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $contact->name }}</td>
                </tr>
                <tr>
                  <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Phone</td>
                  <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $contact->phone }}</td>
                </tr>
                <tr>
                    <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Email</td>
                    <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $contact->email }}</td>
                  </tr>
                  <tr>
                    <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Topic</td>
                    <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $contact->topic }}</td>
                  </tr>

                  <tr>
                    <td class="sm-w-1-4 sm-inline-block" style="color: #718096;" width="50%">Message</td>
                    {{-- <td class="sm-w-3-4 sm-inline-block" style="font-weight: 600; text-align: right;" width="50%" align="right">{{ $contact->Message }}</td> --}}
                  </tr>
             ...
             <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                 ...
                 <h4 style="color: #000;font-weight: 600;">
                    We're excited to learn more about your goals and help you plan your perfect escape with Salty Waves. Should you require immediate assistance or have any urgent questions, don't hesitate to reach out directly via email at: <a href="mailto:info@salty-wave.com">info@salty-wave.com</a> or by phone at: <a href="tel:+4917624898825">+49 1762 489 8825</a>.
                    <br><br>
                    Thank you again for choosing Salty Waves! We look forward to connecting with you soon and shaping your dream surf and yoga experience.
                 </h4>
            </td>
          </tr>
        </table>
