 ...
 <head>
   ...
   <title>new reservation need to confirme</title>
<link href="https://fonts.googleapis.com/css?family=Roboto" rel="stylesheet"><!--<![endif]-->
 ...
 <body style="box-sizing: border-box; margin: 0; padding: 0; word-break: break-word; -webkit-font-smoothing: antialiased; background-color: #f4f4f4e4;">
   <div style="display: none; line-height: 0; font-size: 0;">Hello Said ,A new booking is pending your confirmation. Please review and confirm at your earliest convenience.</div>
           ...
           <tr>
             ...
             <td align="left" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px; position: relative; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
               <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                 <tr>
                   <td width="80%">
                     <h1 class="sm-text-lg all-font-roboto" style="font-weight: 700; line-height: 100%; margin: 0; margin-bottom: 4px; font-size: 24px;">New Booking #{{ $booking->id }} </h1>
                     <p class="sm-text-xs" style="margin: 0; color: #a0aec0; font-size: 14px;">A new booking recieved</p>
                   </td>
               ...
               <p>
                 ...
                 {{-- <br><br> --}}
                 <h4 style="color: #000;font-weight: 600;">  A new booking has been submitted and requires your attention. Here are the details:
                 </h4>
                 {{-- <div style="line-height: 32px;">&zwnj;</div> --}}
                 <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                     <tr>
