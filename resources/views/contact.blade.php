...
<!-- Mirrored from www.adivaha.com/themeforest-travon/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Nov 2023 20:18:39 GMT -->
<!-- Added by HTTrack -->
                    ...
                    <div class="contact-info-wrap">
                        ...
                        <div class="contact-info-box">
                            <div class="contact-info">
                                ...
                                <div class="media-body"><span class="contact-info__text"><a href="tel:+65485965789">(+65) - 48596 - 5789</a> <a href="tel:+65485965789">+65-48596-5789</a></span></div>
                            </div>
                            <div class="contact-info">
                                <h4 class="contact-info__title">Mail Address:</h4>
                                <div class="contact-info__icon bg-theme"><i class="fal fa-envelope"></i></div>
                                <div class="media-body"><span class="contact-info__text"><a href="mailto:info@travon.com">info@travon.com</a> <a href="mailto:info.example@gmail.com">info.example@gmail.com</a></span></div>
                            </div>
                            <div class="contact-info">
                                <h4 class="contact-info__title">Office Address:</h4>
                                <div class="contact-info__icon bg-title"><i class="fal fa-location-dot"></i></div>
                                <div class="media-body"><span class="contact-info__text">Burnsville, MN 55337 Streat,<br>United States</span></div>
                            </div>
                        </div>
                    </div>
                </div>
