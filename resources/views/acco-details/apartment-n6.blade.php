...
<head>
    <title>Salty Waves - Apartment N6 in Taghazout</title>
    <meta name="description" content="Indulge in the ultimate coastal retreat with Apartment N6 at Salty Waves, Taghazout. This luxurious oceanfront apartment combines modern elegance with breathtaking sea views. Immerse yourself in comfort, surf at your doorstep, and experience the essence of Taghazout. Book your stay in Apartment N6 for an unparalleled Taghazout experience.">
    <meta property="og:title" content="Salty Waves - Apartment N6 in Taghazout">
                ...
                <div class="col-xxl-8 col-lg-7">
                    <div class="tour-details">
                        <div class="tour-header">
                            ...
                            <p>5 Guests, 2 Bedrooms, 1 Double Bed, 2 Single Beds, 1 Bathroom, 1 Kitchen, 1 Balcony With Beach View <strong>(€{{ config('global.appartment6') }}.00/day)</strong></p>
                            <div class="meta-box-wrap">
                                <div class="meta-box">
                                    <div class="meta-box_icon"><i class="fal fa-circle-dollar"></i></div>
                                    <div class="media-body">
                                        <h5 class="meta-box_title">From</h5>
                                        <p class="meta-box_text">€{{ config('global.appartment6') }}.00</p>
                                    </div>
                                </div>
                                <div class="meta-box">
                                    ...
                                    <div class="description-table-wrap">
                                        <table class="description-table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Apartement </th>
                                                    <td>5 Guests, 2 Bedrooms, 1 Double Bed, 2 Single Beds, 1 Bathroom, 1 Kitchen, 1 Balcony With Beach View <strong>(€{{ config('global.appartment6') }}.00/day)</strong></td>
                                                </tr>
                                                <tr>
                                                    <th>Airbnb's Rate</th>
                                                    <td>4.83 out of 5</td>
                ...
                <div class="widget widget_book">
                    <div class="widget-tour-book">
                        <div class="top">
                            ...
                            <p class="price">€{{ config('global.appartment6') }}.00 per day</p>
                        </div>
                        <form id="bookingForm" action="{{ route('bookingPost', ['lang' => $lang]) }}" method="POST" class="widget-form">
                            ...
                            <input type="text" name="accommodation" hidden value="Apartment N6">
                            ...
                            <div class="row">
                                <div class=" form-group">
                                    <select disabled class="form-select nice-select">
                                        <option value="" disabled="disabled" selected="selected" hidden>Accommodation: Apartment N6</option>
                        ...
                        document.getElementById('checkout').valueAsDate = checkoutDate;
                            ...
                            function updateTotalCost() {
                                ...
                                if (!isNaN(checkinDate.getTime()) && !isNaN(checkoutDate.getTime())) {
                                    ...
                                    var totalCost = nights * {{ config('global.appartment6') }};
