<div class="tour-card">
    ...
    <div class="tour-card__content">
        ...
        <div class="tour-card__bottom"><span class="tour-card__price">From <span class="price">€505</span></span> <a href="{{ route('surf-coaching', ['lang' => $lang]) }}" class="link-btn">See Details <i class="fas fa-arrow-up-right"></i></a></div>
    </div>
</div>
