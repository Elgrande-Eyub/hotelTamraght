<div class="tour-card">
    ...
    <div class="tour-card__content">
        ...
        <h3 class="tour-card__title"><a href="{{ route('hostel-tamraght', ['lang' => $lang]) }}">Tamraght Surf Camp</a></h3>
        <div class="tour-meta"><span><i class="fa-light fa-clock"></i> 1 Day</span> <span><i class="fa-light fa-user-group"></i> 12</span></div>
        <div class="tour-card__bottom"><span class="tour-card__price">From <span class="price">€{{ config('global.hostelTamraght') }}</span></span> <a href="{{ route('hostel-tamraght', ['lang' => $lang]) }}" class="link-btn">See Details <i class="fas fa-arrow-up-right"></i></a></div>
    </div>
</div>
