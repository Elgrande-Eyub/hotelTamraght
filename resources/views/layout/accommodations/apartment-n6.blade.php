<div class="tour-card">
    ...
    <div class="tour-card__content">
        ...
        <div class="tour-card__bottom"><span class="tour-card__price">From <span class="price">€{{ config('global.appartment6') }}</span></span> <a href="{{ route('apartment-n6', ['lang' => $lang]) }}" class="link-btn">See Details <i class="fas fa-arrow-up-right"></i></a></div>
    </div>
</div>
